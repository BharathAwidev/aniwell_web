...
//           description: currentCategory.description || `Explore our collection of ${currentCategory.name} designs`,
...
//             </button>
//             <button className="bg-transparent border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold py-3 px-8 rounded-lg transition duration-300">
//               View Our Portfolio
//             </button>
//           </div>
//         </div>
...
//         {/* Featured Section */}
//         {categoryData.subCategories && categoryData.subCategories.length > 0 && (
//           <div className="mt-16 bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-2xl p-8 md:p-12">
//             <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
//               <div className="lg:w-2/3">
//                 <h2 className="text-2xl md:text-3xl font-bold mb-4">Why Choose Our {categoryData.name}?</h2>
//                 <p className="text-gray-300 mb-6">
//                   We combine innovative design with practical solutions to create spaces that reflect your personality and lifestyle.
//                   Our team of expert designers ensures every project is unique and tailored to your needs.
//                 </p>
...
//                   <p className="text-gray-300 mb-6">Book a free consultation with our design experts today.</p>
//                   <button className="w-full bg-white text-gray-900 hover:bg-gray-100 font-semibold py-3 px-6 rounded-lg transition duration-300">
//                     Schedule Now
//                   </button>
//                 </div>
//               </div>
...
//               Our expert designers are ready to create your dream home. Schedule a free consultation today!
//             </p>
//             <div className="flex flex-col sm:flex-row gap-4 justify-center">
//               <button className="bg-white text-blue-600 hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg transition duration-300">
//                 Get Free Quote
//               </button>
//               <button className="bg-transparent border-2 border-white hover:bg-white/10 font-semibold py-3 px-8 rounded-lg transition duration-300">
