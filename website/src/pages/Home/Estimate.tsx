...
//         {/* Estimate Cards - Simple Layout */}
//         <div className="max-w-5xl mx-auto">
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
//             {estimateOptions.map((option, index) => (
//               <div key={index} className="space-y-8">
//                 {/* Card */}
//                 <div className="bg-gray-50 rounded-2xl p-8 md:p-10 hover:bg-gray-100 transition-colors duration-300 border border-gray-200">
//                   {/* Icon */}
//                   <div className="text-5xl md:text-6xl mb-6">{option.icon}</div>
...
//                   {/* Button */}
//                   <button className="w-full py-4 bg-orange-500 hover:bg-orange-600 text-white text-lg font-bold rounded-lg transition-all duration-300 hover:shadow-lg transform hover:scale-105">
//                     {option.buttonText}
//                   </button>
//                 </div>
...
//                   <div className="md:hidden pt-8 border-t border-gray-300">
//                     <div className="border-t border-gray-300"></div>
//                   </div>
//                 )}
//               </div>
