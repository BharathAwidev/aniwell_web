...
// const steps = ['Service Details', 'Specifications', 'Pricing & Status', 'Review'];
...
//               required
//               size="small"
//               helperText="e.g., KITCHEN-MOD-001"
//             />
//             <TextField
//               fullWidth
...
//                 </Select>
//               </FormControl>
//               <FormControl fullWidth required size="small" disabled={!formData.categoryId}>
...
//                 onChange={handleInputChange}
//                 size="small"
//                 helperText="e.g., Modern, Contemporary"
//               />
//             </Box>
//           </Box>
//         );
...
//         return (
//           <Paper sx={{ p: 3 }}>
//             <Typography variant="h6" gutterBottom>Review Service Details</Typography>
//             <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              
//               <Box>
//                 <Typography variant="subtitle2" color="text.secondary" gutterBottom>Project Information</Typography>
//                 <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
...
//                     <Typography variant="body1">{formData.sku}</Typography>
//                   </Box>
//                 </Box>
//                 <Box sx={{ mt: 2 }}>
...
//               <Box>
//                 <Typography variant="subtitle2" color="text.secondary" gutterBottom>Category & Specifications</Typography>
//                 <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
//                   <Box sx={{ flex: 1, minWidth: 200 }}>
//                     <Typography variant="caption" color="text.secondary">Category</Typography>
//                     <Chip 
//                       label={selectedCategory?.name || 'Not selected'} 
...
//               <Box>
//                 <Typography variant="subtitle2" color="text.secondary" gutterBottom>Pricing & Status</Typography>
//                 <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
//                   <Box sx={{ flex: 1, minWidth: 150 }}>
...
//                     <Typography variant="body1">₹{formData.cost.toLocaleString()}</Typography>
//                   </Box>
//                   <Box sx={{ flex: 1, minWidth: 150 }}>
//                     <Typography variant="caption" color="text.secondary">Stock</Typography>
//                     <Typography variant="body1">{formData.stock} units</Typography>
//                   </Box>
//                 </Box>
//                 <Box sx={{ mt: 2 }}>
